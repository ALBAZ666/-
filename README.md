...
对盒子说"小卡小卡"唤醒后，再说出指令。以下指令通过本地 Qwen3-0.6B 理解执行。

**音乐播放**
- 小卡小卡，播放《最炫民族风》（或：进入音乐 / 放歌 / 想听歌）
- 小卡小卡，下一首 / 上一首
- 小卡小卡，暂停 / 继续播放
- 小卡小卡，记住我喜欢《甜蜜蜜》 / 我喜欢什么歌

**页面导航**
- 小卡小卡，回到首页 / 退出音乐 / 返回主页（跳转到首页）
- 小卡小卡，打开广场舞列表 / 少儿舞蹈 / 成就页面 / 我的页面 / 设置
- 小卡小卡，切换少儿版 / 切换广场舞版
...
识别到你说的话后，盒子上会显示 **"🎙️ 正在识别..."** → **"🤔 Qwen 正在理解..."** → **"✅ 执行完成"** 的实时状态，并通过 TTS 播报回应。
